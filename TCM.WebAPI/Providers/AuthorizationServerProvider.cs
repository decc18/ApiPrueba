...
namespace TCM.WebAPI.Providers
{
    ...
    public class AuthorizationServerProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            using (UserStore _repo = new UserStore())
            {
                user = await _repo.FindByNameAsync(context.UserName, context.Password, context.ClientId);
                if (string.IsNullOrEmpty(user.UserName) || string.IsNullOrEmpty(user.Id))
                {
                    context.SetError("invalid_grant", "Usuario y/o password incorrecto");
                    return;
                }
                //userRole = await UserManager.GetRolesAsync(context.UserName);
            }
